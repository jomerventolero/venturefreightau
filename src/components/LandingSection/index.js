...
const LandingSection = () => {
  return (
    <container className="flex gap-8 justify-center bg-blue-400 w-screen h-[500px] bg-container px-20">
        <Image draggable={false} src="/assets/landingsection.jpg" width="500" height="280" className="self-center align-middle"/>
        <section className="flex flex-col gap-4 justify-center w-1/4 text-slate-600">
          <Image draggable={false} src="/assets/logo-white.png" className="self-center align-middle" width="400" height="90"/>
          <span className="hover:text-white transition-colors duration-300 ease-in-out cursor-pointer">
          ...
          <span className="flex-row flex items-center gap-4 hover:text-white transition-colors duration-300 ease-in-out cursor-pointer">
