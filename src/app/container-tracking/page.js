...
const ContainerTracking = () => {
  ...
  return (
    <div className="flex flex-col gap-4 justify-center content-center pt-20 sm:pt-20 bg-white">
        <Head>
        ...
        >
            ...
            <div className="flex flex-col sm:flex-row">
                <div className="flex flex-col justify-start items-start sm:px-20">
                    ...
                    <motion.p
                        ...
                        transition={{ duration: 0.5 }}
                        viewport={{ once: true }}
                        className="text-lg leading-7 py-2"
                    >
